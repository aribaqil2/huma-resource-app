                ...
                <div class="card-body">
                    ...
                    <form action="{{ Route('presences.update', $presence->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" class="form-control" name="check_in" value="{{ old('check_in', $presence->check_in) }}" required>
                            @error('check_in')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" class="form-control" id="check_out" name="check_out" value="{{ old('check_out', $presence->check_out) }}">
                            @error('check_out')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control date" id="date" name="date" value="{{ old('date', $presence->date) }}">
                            @error('date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
