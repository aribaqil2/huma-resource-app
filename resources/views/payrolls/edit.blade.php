        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>payroll</h3>
                    <p class="text-subtitle text-muted">Edit payroll data</p>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ Route('payrolls.update', $payroll->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control date" id="pay_date" name="pay_date" value="{{ old('pay_date', $payroll->pay_date) }}" required>
                            @error('pay_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
