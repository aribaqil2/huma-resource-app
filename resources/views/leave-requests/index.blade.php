        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Manage leave requests</p>
                </div>
                                    ...
                                    <td>
                                        @if (session('role') == 'HR')
                                            @if ($LeaveRequest->status == 'pending' || $LeaveRequest->status == 'reject')
                                                <a
                                                    href="{{ route('leave-requests.confirm', $LeaveRequest->id) }}"class="btn btn-success btn-sm">Confirm</a>
                                            @else
                                                <a
                                                    href="{{ route('leave-requests.reject', $LeaveRequest->id) }}"class="btn btn-secondary btn-sm">Reject</a>
                                            @endif
                                            <a
                                                href="{{ route('leave-requests.edit', $LeaveRequest->id) }}"class="btn btn-warning btn-sm">Edit</a>
